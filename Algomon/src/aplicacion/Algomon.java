...
import eventos.BotonInstrucionesEventHandler;
import eventos.BotonJugarEventHandler;
import eventos.BotonSalirEventHandler;
...
public class Algomon extends Application {
	...
	private void inicializarStage(Stage stage) {
		...
		new Musica("opening.mp3");
		Musica.play();
		
		Imagen imagenDeFondo = new Imagen("file:inicio.jpg", 800, 600, false, true);
