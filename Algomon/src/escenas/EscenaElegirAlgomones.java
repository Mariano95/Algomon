...
import cajas.CajaDeEleccionDeAlgomones;
import entrenador.Entrenador;
import eventos.BotonAceptarEventHandler;
...
public class EscenaElegirAlgomones implements Escena<EscenaElegirAlgomones>{
	...
	public void inicializarEscena() {
		...
		Imagen imagenDeFondo = new Imagen("file:elegiralgomones.jpg", 1280, 720, false, true);
