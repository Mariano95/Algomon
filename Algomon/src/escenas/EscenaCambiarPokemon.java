...
import eventos.ElegirEventHandler;
...
public class EscenaCambiarPokemon {
	...
	private void inicializar() {
		...
		for(Pokemon pokemon : pokemons){
			...
			Imagen imagenPokemon = new Imagen("file:" + pokemon.getNombre() + ".gif", 100, 100, false, true);
			Button elegir = new Button();
			ElegirEventHandler botonElegirEventHandler = new ElegirEventHandler(elegir, this.entrenador, pokemon, cajaV1, this.escenaBatalla, this.stage);
