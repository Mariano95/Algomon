...
import eventos.UsarElementoEventHandler;
...
public class EscenaDeObjetos {
	...
	private void inicializar() {
		...
		for(Elemento elemento: elementos){
			...
			Imagen imagenElemento = new Imagen("file:" + elemento.getNombre() + ".jpg", 100, 100, false, true);
			Button usarElemento = new Button();
			UsarElementoEventHandler usarElementoEventHandler = new UsarElementoEventHandler(usarElemento, elemento, this.escenaBatalla, this.stage);
