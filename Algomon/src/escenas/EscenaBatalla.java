...
import eventos.BotonDeAtaqueEventHandler;
import eventos.BotonDeCambioDePokemonEventHandler;
import eventos.BotonDeUsarObjetoEventHandler;
...
import aplicacion.Musica;
import ataque.Ataque;
import barraMenu.BarraDeMenu;
//-------------------------------------------------------------------------------
public class EscenaBatalla implements Escena<EscenaBatalla>{
	...
	public void inicializarEscena() {
		...
		this.imagenPokemon1 = new Imagen("file:" + this.pokemonEntrenador1.getNombre() + "back" + ".gif", 200, 112, false, true);
		this.imagenPokemon2 = new Imagen("file:" + this.pokemonEntrenador2.getNombre() + ".gif", 120, 68, false, true);
		...
		Imagen imagen = new Imagen("file:Escenario2.png", 800, 600, false, true);
		...
		Imagen imagenDeFondoDeLaColumnaDeDatos = new Imagen("file:imagenDeFondoDeLaColumnaDeDatos.png");
	...
	private VBox setAccionesEnLaEscena() {
		...
		BotonDeAtaqueEventHandler botonDeAtaque1EventHandler = new BotonDeAtaqueEventHandler(botonDeAtaque1, this.ataquesPokemonEntrenador1.get(0), this);
		BotonDeAtaqueEventHandler botonDeAtaque2EventHandler = new BotonDeAtaqueEventHandler(botonDeAtaque2, this.ataquesPokemonEntrenador1.get(1), this);
		BotonDeAtaqueEventHandler botonDeAtaque3EventHandler = new BotonDeAtaqueEventHandler(botonDeAtaque3, this.ataquesPokemonEntrenador1.get(2), this);
		...
		BotonDeCambioDePokemonEventHandler botonDeCambioDePokemonEcentHandler = new BotonDeCambioDePokemonEventHandler(botonDeCambioDePokemon, this.cambioDePokemon);
		BotonDeUsarObjetoEventHandler botonDeUsarObjetoEventHandler = new BotonDeUsarObjetoEventHandler(botonDeUsarObjeto, this.escenaDeObjetos);
