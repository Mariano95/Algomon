...
import eventos.BotonCaracteristicasAlgomonEventHandler;
import eventos.BotonDeSelecionDePokemonEventHandler;
...
public class CajaAlgomon {
	...
	protected void inicializar(){
		...
		Imagen imagenDelPokemon = new Imagen("file:" + this.pokemon.getNombre() + ".gif", 200, 140, false, true);
		...
		BotonCaracteristicasAlgomonEventHandler unBotonCaracteristicasAlgomonEventHandler = new BotonCaracteristicasAlgomonEventHandler(botonCaracteristicas, this.pokemon);
		...
		this.imagenTilde = new Imagen("file:tilde.png", 40, 20, false, true);
